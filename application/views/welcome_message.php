		...
		<div class="span8 offset2">
			<div>
				<h2>We live with <strong>creativity</strong></h2>
					<p>Develop.io is here to make sure that your web development goes as smoothly as possible. If you have a question, we are here to answer it! If you have an issue, we are here to fix it! Our team is dedicated to ongoing support with any issue that arises. You worry about your business, we'll worry about your website!</p>
					<p>First impressions are everything! In today's world, these first impressions are rarely personal thanks to the world wide web. A website should present your business the way you want, and look good while doing it! That is precisely what our expert team at Develop.io is prepared to do. Before beginning your project, our team will make sure we fully understand exactly what you want to accomplish and how you want to portray it to your viewers, making your first impression a great one!</p>
					<p>Function vs. form? Why choose? Looking good is just the first step. Develop.io is commited to providing your website with the necessary applications, allowing your website to perform the functions needed. Our team has expert experience in the lastest technologies that provide you with a large range of online applications. Now not only is your site looking good, but it's functional as well.</p>
			</div>
		</div>
		<div class="span6">
	...
	<div class="row">
		<div class="span12">
			<div class="cform" id="contact-form">
				...
				<form action="contact/contact.php" method="post" class="contactForm">
					<div class="row">
						<div class="span6">
...
<div class="container">
	<div class="row">
		<div class="span8 offset2">
			...
			<p class="copyright">
				Develop.io - Web Development Evolved | 498 Inman Ave, Suite 202, Colonia, NJ 07067 <br>
				Copyright © Develop.io | All rights reserved<br><br>
				There are 10 different types of people in this world. We are 1 of them.
